...
syms UpZ DownZ UpR DownR Dis
AXIS_COUNT = 6;
CIRCLE_TOP_RADIUS = UpR;
CIRCLE_BOTTOM_RADIUS = DownR;
DIS_BETWEEN_HINGE = Dis;
...
top_between_hinge_rad = CosineTheorem(DIS_BETWEEN_HINGE, CIRCLE_TOP_RADIUS, CIRCLE_TOP_RADIUS) / 2.0;
bottom_between_hinge_rad = CosineTheorem(DIS_BETWEEN_HINGE, CIRCLE_BOTTOM_RADIUS, CIRCLE_BOTTOM_RADIUS) / 2.0;
rad30 = RAD_30;
rad60 = RAD_60;
